...
namespace ConnectedLevelApp.DataAccess
{
    public class UsersTableService
    {
        ...
        {
            _connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=c:\users\скоропадиг.corp\source\repos\ConnectedLevelApp\ConnectedLevelApp.DataAccess\Database.mdf;Integrated Security=True";
        }
